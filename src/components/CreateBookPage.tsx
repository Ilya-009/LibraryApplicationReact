...
import {Author, fetchAuthors, fetchGenres, Genre} from "../services/fetchData";
import {createNewBook} from "../services/createNewBook";
...
export const CreateBookPage = () => {
    ...
    const handleBookSubmitEvent = () => {
        ...
        createNewBook(book).then(response => {
            if (!response) {
                alert('Ошибка при добавлении новой книги! Повторите попытку');
                return;
            }
            ...
            <div className="add-book-form">
                ...
                <div className="form-param">
                    <div className="form-param-input">
                        ...
                        <div className="form-param-input__input">
                            <input type="text" name="year" onChange={e => setReleaseYear(parseInt(e.target.value))}/>
                        </div>
                    </div>
                </div>
                ...
                <button className="create-book-btn ctrl-btn" onClick={handleBookSubmitEvent}>Создать</button>
            </div>
        </div>
    );
};